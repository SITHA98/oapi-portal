...
%>
	...
	<div class="container">    
        ...
        <div class="panel panel-default">    
            <div class="panel-body" style="background-color: #CCFF;"><h4><b>INTIMATION CLAIM PA00</b></h4></div>    
        </div>    
    </div>
	<fieldset>
...
$('#btnExporttoPDF-Payment-PA00').click(function(){
	...
	var v_number=$('#PA00_TXT_NUMBER').val();
	
	window.open("IntimationClaimPA00.htm?claimnumber="+v_number+"&reportType=1");
