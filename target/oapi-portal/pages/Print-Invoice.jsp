...
%>
	...
	<div class="container">    
        ...
        <div class="panel panel-default">    
            <div class="panel-body" style="background-color: #CCFF;"><h4><b>PRINT INVOICE</b></h4></div>    
        </div>    
    </div>
	<fieldset>
		...
		<legend><b>Report filter</b></legend>
		    ...
		    <table class="form" >
		        ...
		        <tr>
					...
					<td >
						<input type="text" id="txtpolicynumber" name="txtpolicynumber" style="width: 600px; height: 50px; font-size:18pt;" />					       	
					</td>
		        </tr>
		        <tr>
		            <td align="right" >VAT TIN <span class="danger">  </span> : </td>
					<td >
						<input type="text" id="txtvattin" name="txtvattin" style="width: 600px; height: 50px; font-size:18pt;" />					       	
					</td>
		        </tr>
		        <tr>
		        	<td>
		        	...
		        	<td>
				        <button class="btn btn-primary" id="btnExporttoPDF-DailyTellerTotalTxn" style="width: 600px; height: 50px; font-size:18pt;">
		         ...
		         <tr>
		        	<td>
		        		<label>Report HC02-COVID-19 : </label>
		        	</td>
		        	<td>
				        <button class="btn btn-primary" id="btnExporttoPDF-HC02-COVID19" style="width: 600px; height: 50px; font-size:18pt;">
				        	<i class="fa fa-save"></i> PRINT HC02 COVID-19
				        </button>
		        	</td>
		        </tr>
		        <tr>
...
$('#btnExporttoPDF-DailyTellerTotalTxn').click(function(){
	...
	var v_policynumber=$('#txtpolicynumber').val();
	var v_txtvattin=$('#txtvattin').val();
	window.open("PrintInvoice.htm?policynumber="+v_policynumber+ "&vattin="+v_txtvattin+"&reportType=1");
	window.open("Summary.htm?policynumber="+v_policynumber+"&reportType=1");
	window.open("detailCondClause.htm?policynumber="+v_policynumber+"&reportType=1");
});
$('#btnExporttoPDF-HC02-COVID19').click(function(){
	//var branch_id=$('#rpt_tellertrans_selBranch').val();
	//var dateTo=$('#rpt_tellertrans_txtDateTo').val();
	//var dateFrom=$('#rpt_tellertrans_txtDateFrom').val();
	var v_policynumber=$('#txtpolicynumber').val();
	var v_txtvattin=$('#txtvattin').val();
	window.open("PrintInvoiceCovid19.htm?policynumber="+v_policynumber+ "&vattin="+v_txtvattin+"&reportType=1");
	window.open("Summary.htm?policynumber="+v_policynumber+"&reportType=1");
	window.open("detailCondClause.htm?policynumber="+v_policynumber+"&reportType=1");
});
</script>
