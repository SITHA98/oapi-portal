...
%>
	...
	<div class="container">    
        ...
        <div class="panel panel-default">    
            <div class="panel-body" style="background-color: #CCFF;"><h4><b>PRINT PA SCHEDULE</b></h4></div>    
        </div>    
    </div>
	<fieldset>
		...
		<legend><b>Report filter</b></legend>
		    ...
		    <table class="form" >
		        ...
		        <tr>
					...
					<td >
						<input type="text" id="pa00_txtpolicynumber" name="pa00_txtpolicynumber" style="width: 600px; height: 50px; font-size:18pt;" />					       	
					</td>
		        </tr>
...
$('#btnExporttoPDF-PA00').click(function(){
	...
	var v_policynumber=$('#pa00_txtpolicynumber').val();
	var v_txtvattin=$('#pa00_txtvattin').val();
	window.open("PAController.htm?policynumber="+v_policynumber+"&reportType=1");
	window.open("PAController_attachedlist?policynumber="+v_policynumber+"&reportType=1");
