...
@Controller
public class rpt_0022_treaty_report_Controller extends GenericController {
	...
	@RequestMapping(value = "/rpt0022TreatyReport", method = RequestMethod.GET, headers = "Accept=*/*")
...
//			
			...
			reportEngine.initReport(servletContext.getRealPath("WEB-INF/reports/CAM-RE-REPORTS/TREATY_REPORT.jasper"),
					para);
			...
			if (reportType == 1) {
				...
				reportEngine.exportExcel(outputStream, request, response, "TREATY_"+productCate+"_REPORT_FROM_"+fromdate.toUpperCase()+"_TO_"+todate.toUpperCase());
			}
