...
@Controller
public class rpt_0021_BORDERAUX_LIABILITY_Controller extends GenericController {
	...
	@RequestMapping(value = "/rpt0021Liability", method = RequestMethod.GET, headers = "Accept=*/*")
...
//		Application_Properties.SERIAL=1;
		try {
			...
			reportEngine.initReport(servletContext.getRealPath("WEB-INF/reports/CAM-RE-REPORTS/BORDERAUX_LIABILITY_REPORT.jasper"),
					para);
			...
			if (reportType == 1) {
				...
				reportEngine.exportExcel(outputStream, request, response, "Liability");
			}
