...
public class WriteXLSX {
	...
	public static void main(String[] args) throws IOException {
		FileInputStream fis = new FileInputStream(new File("C:/Prince Bank/App/princebank-reports-engine/2_COA_Monthly_test.xlsx"));
		...
		fis.close();
		FileOutputStream fos = new FileOutputStream(new File("C:/Prince Bank/App/princebank-reports-engine/2_COA_Monthly_test.xlsx"));
		workbook.write(fos);
		fos.close();
