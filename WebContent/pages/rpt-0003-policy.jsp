...
<table>
	<tr align="center">
		...
		<td align="left" width="250px">
	        <div class="input-group datepicker-demo date rpt_0003_policy_txtReportDate" data-date=""
				data-date-format="dd-M-yyyy">
		        <input type="text" style="width: 300px; height: 50px; font-size:18pt; text-align: right;" value="<%out.print(fromDate); %>" 
		        id="rpt_0003_policy_txtDateFrom" name="rpt_0003_policy_txtDateFrom" class="form-control" placeholder="dd-MM-yyyy" data-date-format="dd-M-yyyy">
	...
	<tr>
		...
		<td align="left" width="250px">
	        <div class="input-group datepicker-demo date rpt_0003_policy_txtReportDate" data-date=""
		        ...
		        id="rpt_0003_policy_txtDateTo" name="rpt_0003_policy_txtDateTo" class="form-control" placeholder="dd-MM-yyyy" data-date-format="dd-M-yyyy">
		        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
		    </div>
		</td>
	</tr>
	<tr>
		...
		<td align="left" style="padding-left:3px; ">
			 <button class="btn btn-primary" id="rpt_0003_policy_refresh" style="width: 340px; height: 50px; font-size:18pt;">
...
<div class="col-xs-12 content" style="margin-top:0px; display: none;">
     <table style="width: 100%;" id="rpt_0003_policy_datatable" class="table table-bordered table-hover display">                    	
        <thead>
           <tr>
       ...
       <thead>    
       	   <tbody>
       		...
       		<tr>
                ...
                <td align="right"><%out.print(ClsHelper.formatNumber(mPolicy.getCROSS_PREMIUM())); %></td>
...
<script type="text/javascript">
	var v_FromDate = $('#rpt_0003_policy_txtDateFrom').val();
	var v_ToDate = $('#rpt_0003_policy_txtDateTo').val();
	var v_delimiter='-';
	var v_title='Policy-Report'+v_delimiter+ v_FromDate +'-TO-'+ v_ToDate;
	$('#rpt_0003_policy_datatable').DataTable( {
...
$('#rpt_0003_policy_refresh').click(function(){
	//alert('hello');
	var productCode = $('#rpt_0003_policy_productCode').val();
	var vFromDate = $('#rpt_0003_policy_txtDateFrom').val();
	var vToDate = $('#rpt_0003_policy_txtDateTo').val();
	var msg1 = "pages/rpt-0003-policy.jsp?productCode="+productCode+"&FromDate="+vFromDate+"&ToDate="+vToDate;
	//alert(msg1);
	$("#rpt0003policy").load(msg1);
});
// END CODE FOR BASIC DATA TABLE
/*datetime picker*/
 $('.rpt_0003_policy_txtReportDate').datetimepicker({
        language:  'en',
        weekStart: 1,
        todayBtn:  1,
		autoclose: 1,
