...
<%
	...
	//dashboardServices rptService = (dashboardServices)context.getBean("dashboardServices");
...
<table>
	<tr align="center">
		...
		<td align="left" width="250px">
	        <div class="input-group datepicker-demo date dashboard_txtReportDate" data-date=""
				data-date-format="dd-M-yyyy">
		        <input type="text" style="width: 300px; height: 50px; font-size:18pt; text-align: right;" value="<%out.print(fromDate); %>" 
		        id="dashboard_txtDateFrom" name="dashboard_txtDateFrom" class="form-control" placeholder="dd-MM-yyyy" data-date-format="dd-M-yyyy">
	...
	<tr>
		...
		<td align="left" width="250px">
	        <div class="input-group datepicker-demo date dashboard_txtReportDate" data-date=""
		        ...
		        id="dashboard_txtDateTo" name="dashboard_txtDateTo" class="form-control" placeholder="dd-MM-yyyy" data-date-format="dd-M-yyyy">
		        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
		    </div>
		</td>
	</tr>
	<tr>
		...
		<td align="left" style="padding-left:3px; ">
			 <button class="btn btn-primary" id="dashboard_refresh" style="width: 340px; height: 50px; font-size:18pt;">
...
<div class="col-xs-12 content" style="margin-top:0px; display: none;">
     <table style="width: 100%;" id="dashboard_datatable" class="table table-bordered table-hover display">                    	
        <thead>
           <tr>
...
<script type="text/javascript">
	var v_FromDate = $('#dashboard_txtDateFrom').val();
	var v_ToDate = $('#dashboard_txtDateTo').val();
	var v_delimiter='-';
...
$('#dashboard_refresh').click(function(){
	//alert('hello');
	console.log("click 1");
	var productCode = $('#dashboard_productCode').val();
	var vFromDate = $('#dashboard_txtDateFrom').val();
	var vToDate = $('#dashboard_txtDateTo').val();
...
/*datetime picker*/
 $('.dashboard_txtReportDate').datetimepicker({
        language:  'en',
        weekStart: 1,
        todayBtn:  1,
		autoclose: 1,
