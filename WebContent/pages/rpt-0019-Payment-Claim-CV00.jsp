...
%>
	...
	<div class="container">    
        ...
        <div class="panel panel-default">    
            <div class="panel-body" style="background-color: #CCFF;"><h4><b>PAYMENT CLAIM CV00</b></h4></div>    
        </div>    
    </div>
	<fieldset>
...
$('#btnExporttoPDF-Payment-CV00').click(function(){
	...
	var v_payment_number=$('#CV00_TXT_NUMBER').val();
	
	window.open("PAYMENT_CLAIM_CV00.htm?PaymentNumber="+v_payment_number+"&reportType=1");
	//window.open("CV00Controller_detail.htm?claimnumber="+v_claimnumber+"&reportType=1");
