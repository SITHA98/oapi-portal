...
<table>
	<tr align="center">
		...
		<td align="left" width="250px">
	        <div class="input-group datepicker-demo date rpt_0011_borderaux_motor_txtReportDate" data-date=""
				data-date-format="dd-M-yyyy">
		        <input type="text" style="width: 300px; height: 50px; font-size:18pt; text-align: right;" value="<%out.print(fromDate); %>" 
		        id="rpt_0011_borderaux_motor_txtDateFrom" name="rpt_0011_borderaux_motor_txtDateFrom" class="form-control" placeholder="dd-MM-yyyy" data-date-format="dd-M-yyyy">
	...
	<tr>
		...
		<td align="left" width="250px">
	        <div class="input-group datepicker-demo date rpt_0011_borderaux_motor_txtReportDate" data-date=""
		        ...
		        id="rpt_0011_borderaux_motor_txtDateTo" name="rpt_0011_borderaux_motor_txtDateTo" class="form-control" placeholder="dd-MM-yyyy" data-date-format="dd-M-yyyy">
		        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
		    </div>
		</td>
	</tr>
	<tr>
		...
		<td align="left" style="padding-left:3px; ">
			 <button class="btn btn-primary" id="rpt_0011_borderaux_motor_view_pdf" style="width: 340px; height: 50px; font-size:18pt;">
	...
	<tr>
		<td></td>
		<td align="left" style="padding-left:3px; ">
			 <button class="btn btn-primary" id="rpt_0011_borderaux_motor_export_excel" style="width: 340px; height: 50px; font-size:18pt;">
...
$(document).ready(function() {
	$('#rpt_0011_borderaux_motor_datatable').DataTable();
	$('.preloading').fadeOut(500,function(){
		$('.content').fadeIn(500);
	});	
} );
$('#rpt_0011_borderaux_motor_view_pdf').click(function(){
	//alert('hello');
	var productCode = $('#rpt_0011_borderaux_motor_productCode').val();
	var vFromDate = $('#rpt_0011_borderaux_motor_txtDateFrom').val();
	var vToDate = $('#rpt_0011_borderaux_motor_txtDateTo').val();	
	window.open("rpt0011Borderaux.htm?fromdate="+vFromDate+"&todate="+vToDate+ "&reportType=1");
});

$('#rpt_0011_borderaux_motor_export_excel').click(function(){
	//alert('hello');
	var productCode = $('#rpt_0011_borderaux_motor_productCode').val();
	var vFromDate = $('#rpt_0011_borderaux_motor_txtDateFrom').val();
	var vToDate = $('#rpt_0011_borderaux_motor_txtDateTo').val();	
	window.open("rpt0011Borderaux.htm?fromdate="+vFromDate+"&todate="+vToDate+ "&reportType=2");
});
// END CODE FOR BASIC DATA TABLE
/*datetime picker*/
 $('.rpt_0011_borderaux_motor_txtReportDate').datetimepicker({
        language:  'en',
        weekStart: 1,
        todayBtn:  1,
		autoclose: 1,
