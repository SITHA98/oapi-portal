...
%>
	...
	<div class="container">    
        ...
        <div class="panel panel-default">    
            <div class="panel-body" style="background-color: #CCFF;"><h4><b>PAYMENT CLAIM HC00</b></h4></div>    
        </div>    
    </div>
	<fieldset>
		...
		<legend><b>Report filter</b></legend>
		    ...
		    <table class="form" >
		        ...
		        <tr>
					...
					<td >
						<input type="text" id="HC00_TXT_PAYMENT_NUMBER" name="HC00_TXT_PAYMENT_NUMBER" style="width: 600px; height: 50px; font-size:18pt;" />					       	
					</td>
		        </tr>
		        <tr>
		        ...
		        <tr>
		        	...
		        	<td>
				        <button class="btn btn-primary" id="btnExporttoPDF-Payment-HC00" style="width: 600px; height: 50px; font-size:18pt;">
...
$('#btnExporttoPDF-Payment-HC00').click(function(){
	...
	var v_paymentnumber=$('#HC00_TXT_PAYMENT_NUMBER').val();
	
	window.open("PAYMENT_CLAIM_HC00.htm?PaymentNumber="+v_paymentnumber+"&reportType=1");
