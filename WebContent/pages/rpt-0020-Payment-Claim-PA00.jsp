...
%>
	...
	<div class="container">    
        ...
        <div class="panel panel-default">    
            <div class="panel-body" style="background-color: #CCFF;"><h4><b>PAYMENT CLAIM PA00</b></h4></div>    
        </div>    
    </div>
	<fieldset>
		...
		<legend><b>Report filter</b></legend>
		    ...
		    <table class="form" >
		        ...
		        <tr>
					...
					<td >
						<input type="text" id="PA00_TXT_NUMBER" name="PA00_TXT_NUMBER" style="width: 600px; height: 50px; font-size:18pt;" />					       	
					</td>
		        </tr>
		        <tr>
		        ...
		        <tr>
		        	...
		        	<td>
				        <button class="btn btn-primary" id="btnExporttoPDF-Payment-PA00" style="width: 600px; height: 50px; font-size:18pt;">
...
$('#btnExporttoPDF-Payment-PA00').click(function(){
	...
	var v_payment_number=$('#PA00_TXT_NUMBER').val();
	
	window.open("PAYMENT_CLAIM_PA00.htm?PaymentNumber="+v_payment_number+"&reportType=1");
